...
function Section({ title, links }) {
    return (
        <section className="mb-10">
            <p className="mb-4 font-heading text-[calc(1.5rem-2pt)] font-bold text-gray-900 dark:text-white">{title}</p>
            {links.length > 0 ? (
                ...
                <p className="text-[22px] font-light text-gray-400 dark:text-gray-500">Coming soon.</p>
            )}
        </section>
    );
}
...
function Blog() {
    return (
        <AnimWrapper>
            <div className="max-w-2xl mx-auto px-8 pb-10 font-serif text-gray-900 dark:text-gray-100">
